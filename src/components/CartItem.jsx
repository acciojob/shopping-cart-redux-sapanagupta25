                ...
                <div className="col-md-3">
                    <div className="input-group mt-3 mb-5">
                        <div className="input-group-prepend">
                            <button className="btn btn-outline-secondary font-weight-bold" disabled={cartItem.product_qty === 1} onClick={() => removeItemQty(cartItem)}> -- </button>
                        </div>
                        <input type="text" readOnly className="form-control text-center" value={cartItem.product_qty} aria-label="Example text with button addon" aria-describedby="button-addon1" />
                        <div className="input-group-append">
                            <button className="btn btn-outline-secondary font-weight-bold" onClick={() => addItemQty(cartItem)}>+</button>
                        </div>
                    </div>
